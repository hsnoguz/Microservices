...
namespace FreeCourse.Services.Catalog.Services
{
    public class CourseService : ICourseService
    {
        ...
        public async Task<Response<List<CourseDto>>> GetAllAsyc()
        {
            ...
            return Response<List<CourseDto>>.Succes(courseListDto, 200);
        }
        ...
        public async Task<Response<CourseDto>> GetByIdAsync(string id)
        {
            ...
            course.Category = _categoryCollection.Find<Category>(x => x.Id == course.Id).FirstOrDefault();
            CourseDto courseDto = _mapper.Map<CourseDto>(course);
            return Response<CourseDto>.Succes(courseDto, 200);
        }
